...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { difficulty: @history.difficulty, questions: @history.questions, results: @history.results, topic: @history.topic } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { difficulty: @history.difficulty, questions: @history.questions, results: @history.results, topic: @history.topic } }
