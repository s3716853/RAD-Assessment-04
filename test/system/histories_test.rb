...
class HistoriesTest < ApplicationSystemTestCase
  ...
  test "creating a History" do
    ...
    fill_in "Difficulty", with: @history.difficulty
    fill_in "Questions", with: @history.questions
    fill_in "Results", with: @history.results
    fill_in "Topic", with: @history.topic
